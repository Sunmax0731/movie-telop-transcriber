...
- 左ペインの出力、ログ、作業ディレクトリはコピー操作を持つステータスカードとして扱う。
- `#88` で設定画面を 2 ペイン構成に整理し、出力先フォルダ設定を左ペインへ移動した。
...
4. 現在の個別 Issue: `#87`、`#74`、`#88` UI/UX 改善
...
- 設定ボタンから開く非モーダル子ウィンドウで、言語、出力先フォルダ、PaddleOCR 調整を 2 ペインで編集する。
