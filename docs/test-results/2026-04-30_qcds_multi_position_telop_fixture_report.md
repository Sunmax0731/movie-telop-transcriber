...
- Run ID: `fixture_multi_position_telop`

## 2. 入力
- 正解データ: `test-data\qcds_suite\multi_position_telop_ground_truth.json`
- 解析結果: `temp\qcds-fixtures\multi_position_telop\output\segments.json`
- サマリ: `temp\qcds-fixtures\multi_position_telop\logs\summary.json`

## 3. 再生成コマンド
```powershell
python tools/validation/evaluate_qcds_report.py `
  --ground-truth test-data\qcds_suite\multi_position_telop_ground_truth.json `
  --segments temp\qcds-fixtures\multi_position_telop\output\segments.json `
  --summary temp\qcds-fixtures\multi_position_telop\logs\summary.json `
  --sample-id multi_position_telop `
  --output docs\test-results\2026-04-30_qcds_multi_position_telop_fixture_report.md `
  --metrics-output docs\test-results\2026-04-30_qcds_multi_position_telop_fixture_metrics.json
```
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| seg-0001 | seg-0001 | 上段テロップ | 上段テロップ | 100.0% | 0 ms | 0 ms | 97.0% |
| seg-0002 | seg-0002 | 下段テロップ | 下段テロップ | 100.0% | 0 ms | 0 ms | 97.0% |
| seg-0003 | seg-0003 | 中央テロップ | 中央テロップ | 100.0% | 0 ms | 0 ms | 96.0% |
