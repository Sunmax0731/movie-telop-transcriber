...
- Run ID: `fixture_low_contrast_telop`

## 2. 入力
- 正解データ: `test-data\qcds_suite\low_contrast_telop_ground_truth.json`
- 解析結果: `temp\qcds-fixtures\low_contrast_telop\output\segments.json`
- サマリ: `temp\qcds-fixtures\low_contrast_telop\logs\summary.json`

## 3. 再生成コマンド
```powershell
python tools/validation/evaluate_qcds_report.py `
  --ground-truth test-data\qcds_suite\low_contrast_telop_ground_truth.json `
  --segments temp\qcds-fixtures\low_contrast_telop\output\segments.json `
  --summary temp\qcds-fixtures\low_contrast_telop\logs\summary.json `
  --sample-id low_contrast_telop `
  --output docs\test-results\2026-04-30_qcds_low_contrast_telop_fixture_report.md `
  --metrics-output docs\test-results\2026-04-30_qcds_low_contrast_telop_fixture_metrics.json
```
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| seg-0001 | seg-0001 | 背景になじむ字幕 | 背景になじむ字幕 | 100.0% | 0 ms | 0 ms | 95.0% |
| seg-0002 | seg-0002 | 低コントラスト検証 | 低コントラスト検証 | 100.0% | 0 ms | 0 ms | 94.0% |
