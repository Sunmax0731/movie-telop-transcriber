...
## 2. 入力
- 正解データ: `test-data\basic_telop\ground_truth.json`
- 解析結果: `work\runs\20260429_033541_3031\output\segments.json`
- サマリ: `work\runs\20260429_033541_3031\logs\summary.json`
